...
\centering
\subbottom[]{\includegraphics[height=5.1cm]{3results_capsule/pics/apl.png} \label{fig:lip_apl}} 
\end{minipage}
\begin{minipage}{0.39\linewidth}
\centering
\subbottom[]{\includegraphics[height=5.1cm]{3results_capsule/pics/diff.png} \label{fig:lip_diff}}
\end{minipage}
\begin{minipage}{0.59\linewidth}
\centering
\subbottom[]{\includegraphics[height=5.1cm]{3results_capsule/pics/order.png} \label{fig:lip_ord}} 
\end{minipage}
\begin{minipage}{0.39\linewidth}
\centering
\subbottom[]{\includegraphics[width=\linewidth]{3results_capsule/pics/pb4_S6.png} \label{fig:S6_pb4}} \vfill
\end{minipage}
...
The fact that all the different perturbations lead to a quantitatively similar reduction of ApL suggests that the membrane is approaching the maximum packing allowed.
%
...
To investigate whether the peptide has a more specific action on the membrane and which residues are involved in it, we performed electroporation simulations.
%
...
%\begin{figure}[p!]
%\centering
%\subbottom[]{\includegraphics[height=0.33\linewidth]{3results_capsule/pics/apl.png} \label{fig:lip_apl}} 
%\subbottom[]{\includegraphics[height=0.33\linewidth]{3results_capsule/pics/diff.png} \label{fig:lip_diff}} 
%\subbottom[]{\includegraphics[height=0.33\linewidth]{3results_capsule/pics/order.png} \label{fig:lip_ord}} 
%\subbottom[]{\includegraphics[height=0.33\linewidth]{3results_capsule/pics/pb4_S6.png} \label{fig:ord_pb4}} 
%\caption{\textbf{[REDO w/ LEGEND INSIDE?]} Area per lipid (ApL, panel a) and lateral lipid diffusion coefficient (D, panel b) from membrane patches simulated under different conditions. On the left a schematic of the system set up is showed (L number of lipids, P number of peptides, E electric field applied in the z direction, in mV/nm ). Black points refer to simulations on 512 lipids patches, blue ones on 740 lipids patches; squares denotes presence of peptide molecules; in panel b full symbol are for DLPC and hollow for DLPG. Bars denote the standard error; for the diffusion coefficient, these are smaller than the point size.}
%\label{fig:lipids_ApL_D}
%\end{figure}
