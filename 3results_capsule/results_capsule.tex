...
To be noticed that SIRAH simulations, run at $\epsilon = 1$, present Coulomb components 2.5 times larger than the ones of Polar MARTINI, suggesting that the two water models, both representing the separation of water charges in an approximate way, give a similar energy contribution despite being different.
...
\caption[Non-bonded protein energy contribution to capsule structures]{(a) Protein-Protein and Protein-Water non-bonded interactions, normalised per molecule. (b) Ratio between the Protein-Protein and Protein-Water interactions from plot (a), for Coulomb and Lennard-Jones respectively.}
\label{fig:eng_cg}
\end{figure}
...
\begin{figure}[p!]
\centering
\subbottom[]{\includegraphics[width=0.5\linewidth]{3results_capsule/pics/compare_MonoBi_RDF.png} \label{fig:rdf_mono_bi}} \\
\subbottom[]{\includegraphics[width=0.48\linewidth]{3results_capsule/pics/compare_MonoBi_rmsd.png} \label{fig:rmsd_mono_bi}}
\subbottom[]{\includegraphics[width=0.48\linewidth]{3results_capsule/pics/compare_MonoBi_rmsd_init.png} \label{fig:rmsd_init_mono_bi}} 
\caption[bb]{(a) }
\label{fig:mono_bi_comparison}
\end{figure}
