...
Moreover, additional simulations were run at all the coarse-grain levels on a structure made of one layer only (i.e.\ built from pentagonal subunit make by one pentagon only), to prove whether the bilayer is more energetically favoured.

Finally, a preliminary study on self-assembly was performed with one of the coarse grain representations (namely MARTINI with standard water), starting from capzip molecules randomly placed in a box of solution.
